...
KHADKA PHOTO BOOTH is designed to provide a seamless "Studio" experience directly in your browser. It uses media pipe to track hand landmarks in real-time while allowing users to capture a sequence of 5 poses, which are then compiled into a classic, vertically-oriented physical-style photo strip.

# Features

Real-time Tracking: Integrated with Google MediaPipe for high-fidelity hand landmark detection and skeletal overlays.
